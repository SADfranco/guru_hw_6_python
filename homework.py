...
def test_dark_theme_by_time_and_user_choice():
    ...
    if dark_theme_enabled_by_user:
        is_dark_theme = True
    elif dark_theme_enabled_by_user == None and 22 <= current_time.hour or current_time.hour < 6:
        is_dark_theme = True
    else:
        is_dark_theme = False
...
def rename_func(name, *args):
    new_name = name.__name__.replace('_', ' ')
    argum = ', '.join(args)
    actual_result = f'{new_name.title()} [{argum}]'
